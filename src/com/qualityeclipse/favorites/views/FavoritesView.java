...
import com.qualityeclipse.favorites.model.IFavoritesListener;
...
public class FavoritesView extends ViewPart {
	...
	private final IFavoritesListener favoritesItemListener = new IFavoritesListener() {
	...
	private void createTableViewer(Composite parent) {
		...
		FavoritesManager.getManager().addFavoritesListener(
				favoritesItemListener);
	}
	...
	private void createContributions() {
		...
		removeContributionItem = new RemoveFavoritesContributionItem(
	...
	public void dispose() {
		...
		FavoritesManager.getManager().removeFavoritesListener(
				favoritesItemListener);
		super.dispose();
	}

...
/**
 * A group of related property entries in a {@link PropertyFile} with a comment
 * preceding the group indicating the name. The category can extract its name
 * and entries from a reader object.
 */
